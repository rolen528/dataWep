...
class BlogApiControllerTest {
    ...
    @Autowired
    protected ObjectMapper objectMapper;    // 직렬화, 역직렬화 클래스 (JSON - JAVA)
    ...
    public void addArticle() throws Exception {
        ...
        // when
        // 설정한 내용을 바탕으로 요청 전송
        ResultActions result = mockMvc.perform(post(url)    // 위치
                .contentType(MediaType.APPLICATION_JSON_VALUE)  // 데이터 타입
                .content(requestBody)); // 데이터
